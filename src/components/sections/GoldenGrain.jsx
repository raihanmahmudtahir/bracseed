...
const GoldenGrain = () => {
  const products = [
    {
      name: "Brac 14 (RXML 22)",
      type: "Hybrid",
      image: "/brac14.png", // Path from public folder
      details: {
    ...
    },
    {
      name: "Mukti 1 (F1)",
      type: "Hybrid",
      image: "/mukti1.png", // Path from public folder
      details: {
        sowingTime: "August-November",
        harvest: "50-60 days after sowing",
        fruitWeight: "3.0-3.5 kg",
    ...
    },
    {
      name: "Brac 777 (F1)",
      type: "Hybrid",
      image: "/brac777.png", // Path from public folder
      details: {
        sowingTime: "August-November",
        harvest: "50-60 days after sowing",
        fruitWeight: "3.0-3.5 kg",
    ...
    {
      name: "Brac Aloron (HB 8)",
      type: "Hybrid",
      image: "/bracaloron.png", // Path from public folder
      details: {
        sowingTime: "August-November",
        harvest: "50-60 days after sowing",
        fruitWeight: "3.0-3.5 kg",
    ...
    <div className="w-full h-auto bg-white">
      ...
      <div className="w-full relative">
        <Image
          ...
          src="/goldengrainbanner.jpeg" // Image from public folder
          alt="Golden Grain Banner"
        />
      ...
      <Image
        ...
        src="/goldengrainbanner.jpeg" // Image from public folder
        alt="Golden Grain Footer"
      />
    </div>
  );
};

export default GoldenGrain;
