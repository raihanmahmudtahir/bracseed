...
const OtherCrops = () => {
  const products = [
    {
      name: "Sunflower (Hysun 33)",
      type: "Hybrid",
      image: "/assets/sunflower.png", // Image path from the public folder
      details: {
    ...
    <div className="w-full h-auto bg-white">
      ...
      <div className="w-full relative">
        <Image
          ...
          src="/assets/othercropsbanner.jpeg" // Image from public folder
          alt="Other Crops Banner"
          layout="responsive"
          width={1920}
          height={450}
        />
              ...
              <div className="mt-4">
                <div className="grid grid-cols-3 text-[#2f313c] text-base font-dm gap-2">
                  ...
                  <div className="col-span-1">
                    {product.details.sowingTime}<br />
                    {product.details.harvest}<br />
                    {product.details.fruitWeight}<br />
                    {product.details.fruitType}<br />
                    {product.details.seedRate}<br />
                    {product.details.yield}<br />
