...
const VersatileTuber = () => {
  const products = [
    {
      name: "Diamant",
      type: "Hybrid",
      image: "/assets/diamant1.png",
      details: {
    ...
    <div className="w-full h-auto bg-white">
      ...
      <div className="w-full relative">
        <Image
          ...
          src="/assets/versatiletuberbanner.jpeg"
          alt="Versatile Tuber Banner"
        />
